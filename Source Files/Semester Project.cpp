...
#include<stdlib.h>
using namespace std;
//color options: RED, WHITE, PINK, PURPLE, VIOLET, BLUE, NEON, ORANGE, GREY, SKY
//width options: 2, 5, 8
// 
//returning -1 usually means incomplete input
...
int numCalc(char input_array[]) {   //calculates the integer number at the end of the [fd, bk, rt, lt and circle] commands
	int i, j;
	int key = -1;
	for (i = 0; (((input_array[i] < '0') || (input_array[i] > '9')) && (input_array[i] != '\0')); i++) {    //stops at the starting digit of the integer
...
int widthCalc(char input_array[]) {   //calculates the integer number at the end of the [fd, bk, rt, lt and circle] commands
	int i;
	int key = -1;
	for (i = 0; (((input_array[i] < '0') || (input_array[i] > '9')) && (input_array[i] != '\0')); i++) {    //stops at the starting digit of the integer
		if ((input_array[i + 1] >= '0') && (input_array[i + 1] <= '9'))
...
int colorCalc(char input_array[]) { //calculates the color at the end of the [color] command (0 = wrong input, 1 = RED, 2 = WHITE, 3 = PINK, 4 = PURPLE, 5 = VIOLET, 6 = BLUE, 7 = NEON, 8 = ORANGE, 9 = GREY, 10 = SKY)
	int i;
	int key = -1;
	for (i = 0; (((input_array[i] < 65) || (input_array[i] > 90)) && (input_array[i] != '\0')); i++) {    //stops at the starting of the uppercase color
...
void fileNameMaker(char arrayDest[], char arraySource[], int commaOneIndex, int commaTwoIndex) { //stores the string between the indexes of comma 1 and 2 in a seperate arry to be used as the file creation;
	int x = 0;
...
bool fileNameVerifier(char input_array[], char fileName[]) { //verifies filename inside double quotations and stores filename in the filename array to be used for ifstream/ofstream declarations
...
int repeatLoopCalc(char input_array[]) {   //calculates the integer number at the end of the [fd, bk, rt, lt and circle] commands
	int i;
	int key = -1;
	for (i = 0; (((input_array[i] < '0') || (input_array[i] > '9')) && (input_array[i] != '\0') && (input_array[i] != '[')); i++) {    //stops at the starting digit of the integer
		if ((input_array[i + 1] >= '0') && (input_array[i + 1] <= '9'))
			key = 1;
	}
	int sum;
...
void arrayShifter(char array_to_shift[], int index) {    //shifts deletes all the elements in array BEFORE the index and shifts array back until index is at position 0
	int start = 0;
...
int functionEndIndex(char input_array[]) {
	...
	for (j = i; input_array[j] >= 97 && input_array[j] <= 122; j++) {} // ends at the index immediately after the function text stops
	return j;
}

int repeatNumCalc(char input_array[]) {   //calculates the integer number at the end of the [fd, bk, rt, lt and circle] commands within the repeat brackets and shifts array back
	int i, j;
	int key = -1;
	int start = functionEndIndex(input_array);
	for (i = start; (((input_array[i] < '0') || (input_array[i] > '9')) && ((input_array[i] < 97) || (input_array[i] > 122)) && ((input_array[i] < 65) || (input_array[i] > 90)) && (input_array[i] != '\0') && (input_array[i] != ']')); i++) {    //stops at the starting digit of the integer
		if ((input_array[i + 1] >= '0') && (input_array[i + 1] <= '9'))
			key = 1;
	}
...
int repeatColorCalc(char input_array[]) { //calculates the color at the end of the [color] command (0 = wrong input, 1 = RED, 2 = WHITE, 3 = PINK, 4 = PURPLE, 5 = VIOLET, 6 = BLUE, 7 = NEON, 8 = ORANGE, 9 = GREY, 10 = SKY)
	int i;
	int key = -1;
	int start = functionEndIndex(input_array);
	for (i = start; (((input_array[i] < 65) || (input_array[i] > 90)) && ((input_array[i] < 97) || (input_array[i] > 122)) && (input_array[i] != '\0') && (input_array[i] != ']')); i++) {    //stops at the starting of the uppercase color
		if ((input_array[i + 1] >= 65) && (input_array[i + 1] <= 90))
			key = 1;
	}
...
//-----------------------
//function checkers
bool fdChecker(char input_array[]) {    //returns true if the inputted function is 'fd', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the fd
	bool ans = false;
...
bool bkChecker(char input_array[]) {    //returns true if the inputted function is 'bk', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the bk
	bool ans = false;
...
bool rtChecker(char input_array[]) {    //returns true if the inputted function is 'rt', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the rt
	bool ans = false;
...
bool ltChecker(char input_array[]) {    //returns true if the inputted function is 'lt', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the lt
	bool ans = false;
...
bool circleChecker(char input_array[]) {    //returns true if the inputted function is 'circle', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the circle
	bool ans = false;
...
bool puChecker(char input_array[]) {    //returns true if the inputted function is 'pu', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the pu
	bool ans = false;
...
bool pdChecker(char input_array[]) {    //returns true if the inputted function is 'pd', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the pd
	bool ans = false;
...
bool widthChecker(char input_array[]) {    //returns true if the inputted function is 'width', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the width
	bool ans = false;
...
bool colorChecker(char input_array[]) {    //returns true if the inputted function is 'color', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the color
	bool ans = false;
...
bool csChecker(char input_array[]) {    //returns true if the inputted function is 'cs', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the cs
	bool ans = false;
	if (input_array[i] == 'c' && input_array[i + 1] == 's')
		ans = true;
	//for (int j = i + 2; input_array[j] != '\0'; j++) {
		//if (input_array[j] != ' ' && input_array[j] != '\0')
			//ans = false;    //sets ans to false if anything other than spaces after 'cs' is detected
	//}
	return ans;
}

bool repeatChecker(char input_array[]) {    //returns true if the inputted function is 'repeat', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the repeat
	bool ans = false;
...
bool saveChecker(char input_array[]) {    //returns true if the inputted function is 'repeat', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the repeat
	bool ans = false;
...
bool loadChecker(char input_array[]) {    //returns true if the inputted function is 'repeat', returns false otherwise.
	int i;
	for (i = 0; input_array[i] == ' '; i++) {} //checks for spaces before the repeat
	bool ans = false;
...
int argumentUpdater(int arg, int ang) { //argument and angle, use this to find the limit for running the loop to get the new coordinates for the lines
	int updatedArg = 0;
...
void rightTurn(int& angle, int angleArgument) { //remember to add a paremeter that lets the program know whether an invalid angle was entered or not
...
void leftTurn(int& angle, int angleArgument) { //remember to add a paremeter that lets the program know whether an invalid angle was entered or not
	angleArgument = angleIncrCalc(angleArgument);
	angle -= angleArgument;
	if (angle < 0)
		angle += 360;
...
int main()
{
	...
	while (true) {
		...
		//myLine(180, 420, 180, 539, 255, 255, 255, 2);
		//command history
		lineskip(19, 0);
		...
		//myLine(188, 540, 1500, 540, 255, 255, 255, 2);
		//gotoxy(0, 28);
